...
- **Every chain, one interface.** EVM, Solana, XRPL, Sui, Bitcoin, Cosmos, Tron, TON, Spark, Filecoin, Atto — all first-class. CAIP-2/CAIP-10 addressing abstracts away chain-specific details.
...
// => accounts for EVM, Solana, Bitcoin, Cosmos, Tron, TON, Filecoin, Sui, XRPL, and Atto
...
| Atto | Ed25519 | `atto://` URI | `m/44'/1869902945'/0'` |
